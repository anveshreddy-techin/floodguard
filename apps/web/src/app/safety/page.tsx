    ...
    <div className={`flex flex-col min-h-screen transition-all duration-500 select-none ${
      ...
      <div className="flex flex-1 min-h-0 relative">
        ...
        <main className="flex-1 p-3.5 sm:p-5 lg:p-6 max-w-7xl mx-auto space-y-5 pb-24 md:pb-6">
          ...
          {/* Master Spatial Evacuation Vector Schematic Diagram */}
          <div className="fp fp-operational rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6">
            ...
            <div className="bg-slate-950/80 p-8 rounded-2xl border border-cyan-500/20 flex flex-col md:flex-row items-center justify-around gap-6 shadow-inner relative overflow-hidden">
              {/* YOU Node */}
              <div className="flex flex-col items-center text-center space-y-1 z-10">
                <div className="w-16 h-16 rounded-full bg-blue-600/20 border-2 border-cyan-400 flex items-center justify-center text-cyan-300 font-mono font-black text-xl animate-pulse shadow-[0_0_20px_rgba(6,182,212,0.8)]">
                  🔵
                </div>
                <div className="font-black text-white text-sm mt-1">YOU</div>
              ...
              <div className="flex-1 flex flex-col items-center justify-center space-y-2 w-full max-w-xs z-10">
                ...
                <div className="w-full h-2.5 bg-gradient-to-r from-blue-500 via-cyan-400 to-emerald-400 rounded-full relative shadow-[0_0_15px_rgba(6,182,212,0.6)]">
                  <div
                    className="w-4 h-4 rounded-full bg-white absolute top-1/2 -translate-y-1/2 shadow-[0_0_12px_rgba(255,255,255,1)]"
              ...
              <div className="flex flex-col items-center text-center space-y-1 z-10">
                <div className="w-16 h-16 rounded-full bg-emerald-600/20 border-2 border-emerald-400 flex items-center justify-center text-emerald-300 font-mono font-black text-xl shadow-[0_0_20px_rgba(16,185,129,0.8)]">
                  🟢
                </div>
