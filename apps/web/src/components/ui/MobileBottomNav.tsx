...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({ onOpenDrawer }) => {
  ...
  return (
    <nav 
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 z-50 mobile-nav-bar safe-bottom select-none"
    >
      <div className="flex items-center justify-around px-2 py-1.5 h-16 max-w-lg mx-auto">
            ...
            >
              <div className="relative">
                <Icon className={`w-5 h-5 transition-transform ${
                  isActive ? 'scale-110 text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]' : ''
              ...
              {isActive && (
                <div className="w-6 h-0.5 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full mt-0.5 shadow-[0_0_8px_rgba(6,182,212,1)]" />
              )}
            </Link>
          );
        })}
        ...
        >
          <div className="w-5 h-5 rounded-lg bg-slate-900 border border-slate-700 flex items-center justify-center text-cyan-400">
