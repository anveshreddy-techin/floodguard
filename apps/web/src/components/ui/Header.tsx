        ...
        <div className="h-14 px-3 sm:px-4 lg:px-6 flex items-center justify-between gap-2 sm:gap-3 max-w-full relative bg-[#0C1527] text-white">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className="flex px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-bold bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 border border-cyan-400/50 text-white items-center gap-1.5 shadow-[0_0_12px_rgba(6,182,212,0.3)] active:scale-95 transition shrink-0"
        ...
        <div className="h-8 border-t border-slate-200 bg-[#EDF2F7] px-3 sm:px-4 flex items-center justify-between gap-2 text-xs select-none overflow-x-auto no-scrollbar shadow-xs">
          {isCitizen ? (
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <Link
                href="/safety"
                className="px-2.5 py-0.5 rounded-lg bg-white hover:bg-slate-100 text-blue-700 text-[11px] font-bold border border-slate-300 transition shrink-0 shadow-2xs"
              >
                {t('nearby_shelters')}
              </Link>
              <Link
