  ...
  return (
    <>
      ...
      >
        ...
        <div className="h-8 border-t border-slate-200/90 bg-white/95 px-3 sm:px-4 flex items-center justify-between gap-2 text-xs select-none overflow-x-auto no-scrollbar shadow-xs">
          {isCitizen ? (
            /* Citizen Context Strip */
            <div className="flex items-center gap-2 shrink-0">
              <button
                onClick={() => setLocationModalOpen(true)}
                className="flex items-center gap-1.5 px-2 py-0.5 rounded-lg bg-blue-50/80 text-blue-700 border border-blue-200 text-[11px] font-bold hover:bg-blue-100/70 active:scale-95 transition shrink-0"
              ...
              <Link
                href="/safety"
                className="px-2.5 py-0.5 rounded-lg bg-slate-50 hover:bg-slate-100 text-blue-700 text-[11px] font-bold border border-slate-200 transition shrink-0"
              >
                {t('nearby_shelters')}
              </Link>
              <Link
            ...
            <div className="flex items-center justify-between gap-3 w-full">
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button
                  onClick={() => setLocationModalOpen(true)}
                  className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-lg bg-slate-50 hover:bg-blue-50 text-slate-800 hover:text-blue-700 border border-slate-200 hover:border-blue-300 font-bold active:scale-95 transition shrink-0 text-[11px]"
