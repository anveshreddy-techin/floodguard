  ...
  return (
    <>
      ...
      >
        ...
        <div className="h-14 px-2 sm:px-4 lg:px-6 flex items-center justify-between gap-1.5 sm:gap-3 max-w-full relative">
          ...
          <div className="hidden md:flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-1.5 rounded-lg font-mono font-black text-xs text-white bg-red-600 hover:bg-red-700 active:scale-95 transition-all shadow-md shrink-0 border border-red-700"
            ...
            >
              ...
              <span className="px-1.5 py-0.2 text-[9px] bg-red-800 rounded text-white font-mono font-bold">
                DISPATCH
              </span>
            </button>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-white hover:bg-slate-50 border border-slate-300 text-slate-800 text-xs font-bold transition shadow-sm"
            >
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-1 px-3 py-1 rounded-full font-mono font-black text-[11px] text-white bg-red-600 active:scale-95 shadow-sm shrink-0 border border-red-700"
            ...
            {/* Public Information Portal Switcher (Government Yellow/Amber button) */}
            <Link
              href="/portal"
              className="flex px-2.5 sm:px-3 py-1.5 rounded-lg text-xs font-mono font-black bg-amber-500 hover:bg-amber-600 border border-amber-600 text-slate-950 items-center gap-1.5 shadow-sm active:scale-95 transition shrink-0"
            ...
            {/* AI Copilot Button (Government Blue button) */}
            <button
              onClick={() => {
                if (typeof window !== 'undefined') {
              ...
              className="flex px-2.5 sm:px-3 py-1.5 rounded-lg text-xs font-mono font-black bg-blue-600 hover:bg-blue-700 border border-blue-700 text-white items-center gap-1 shadow-sm active:scale-95 transition shrink-0"
            ...
            <div className="hidden md:flex items-center gap-1 bg-white border border-slate-300 px-2.5 py-1.5 rounded-lg text-xs font-mono shrink-0 shadow-sm">
              <UserCheck className="w-3.5 h-3.5 text-blue-600 shrink-0" />
              <select
                value={role}
                onChange={(e) => setRole(e.target.value as UserRole)}
                className="bg-transparent text-xs text-slate-900 font-bold focus:outline-none cursor-pointer max-w-[130px] truncate"
              >
                {ROLES_LIST.map((r) => (
            ...
            {/* Language Switcher */}
            <div className="hidden sm:flex items-center gap-1 bg-white border border-slate-300 px-2 py-1.5 rounded-lg text-xs font-mono shrink-0 shadow-sm">
            ...
            <button
              ...
              className="hidden sm:flex p-2 rounded-lg bg-white border border-slate-300 text-slate-700 hover:text-slate-950 hover:bg-slate-50 transition shrink-0 active:scale-95 shadow-sm"
        ...
        <div className="h-8 border-t border-slate-200 bg-slate-100/90 px-3 sm:px-4 flex items-center justify-between gap-2 text-[11px] font-mono select-none overflow-x-auto no-scrollbar">
          {isCitizen ? (
