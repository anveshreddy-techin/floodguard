...
export const APP_HUBS: Record<AppHubKey, AppHub> = {
  OPERATIONS: {
    ...
    apps: [
      ...
      { id: 'role-workspace', label: 'Roles & Incident SOPs', href: '/role-workspace', icon: Users, tag: 'Roles & SOP' },
  ...
  GEOSPATIAL: {
    ...
    apps: [
      ...
      { id: 'cascade', label: 'Cascade & Simulation', href: '/cascade', icon: Layers, tag: 'Physics & Lab' },
  ...
  FORENSICS: {
    ...
    apps: [
      ...
      { id: 'ledger', label: 'Prediction Ledger & Audit', href: '/ledger', icon: Database, tag: 'Ledger & Audit' },
      { id: 'benchmark', label: 'Benchmark & Accuracy', href: '/benchmark', icon: BarChart3, tag: 'Metrics' },
    ],
  },
  GOVERNANCE: {
    key: 'GOVERNANCE',
    label: 'National Governance & Public Portal',
    desc: 'ML Model Monitoring, Admin Governance, Recovery & Public Interface',
    ...
    apps: [
      ...
      { id: 'public-portal', label: 'Public Portal & Recovery', href: '/portal', icon: Globe, tag: 'Public & Rehab', badgeColor: 'amber' },
    ],
  },
};
