      ...
      <div className="absolute bottom-4 right-3 z-[400] hidden lg:flex flex-col items-end pointer-events-none">
        {!guideOpen ? (
          <button
            ...
            className="pointer-events-auto px-3.5 py-1.5 rounded-2xl bg-white/95 hover:bg-white border border-slate-200 text-slate-800 hover:text-blue-600 shadow-md backdrop-blur-md flex items-center gap-2 text-xs font-mono font-bold transition active:scale-95"
            title="Open Hydraulic & Refuge Legend"
          >
          ...
          <div className="flex flex-col gap-1.5 p-3 rounded-2xl bg-white/95 border border-slate-200 backdrop-blur-md shadow-xl text-[10px] font-mono pointer-events-auto max-w-[310px] animate-slide-up">
