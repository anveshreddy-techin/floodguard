...
export const PublicHeader: React.FC = () => {
  ...
  return (
    <header className="w-full bg-white text-slate-900 border-b border-slate-200 select-none">
      {/* 1. Government-Format Top Utility Bar (Matches Reference Image) */}
      <div className="bg-slate-50 border-b border-slate-200 text-slate-600 text-[11px] py-1 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[1600px] mx-auto flex flex-wrap items-center justify-between gap-2">
          {/* Left: Government of India Sovereignty Header */}
          ...
          <div className="flex items-center gap-3 sm:gap-4 ml-auto">
            <a
              ...
              className="text-slate-600 hover:text-slate-900 focus:not-sr-only focus:bg-amber-200 px-1 py-0.5 rounded transition font-medium"
            >
      ...
      {/* 2. Main Institutional Identity Banner (Matches Reference Image Exactly) */}
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5">
          <Link href="/portal" className="flex-shrink-0" aria-label="Home">
            <div className="p-0.5">
              <StateEmblem size={48} className="text-slate-800" />
            </div>
          </Link>
        ...
        <div className="flex items-center justify-end gap-3.5 self-end md:self-center">
          ...
          {/* User Profile: Welcome, Control Room */}
